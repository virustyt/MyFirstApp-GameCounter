...
class AddPlayerTableViewCell: UniversalTableViewCell {
...
//    }
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        playerNameLabel.font = UIFont(name: "nunito-extrabold", size: 16)
        playerNameLabel.text = "Add player"
        sortIconImageView.image = nil
    }
}
